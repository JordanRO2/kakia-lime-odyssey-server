...
/// <summary>
/// Server->Client packet for launching a bullet skill at a position.
/// </summary>
/// <remarks>
/// IDA Verified: Yes (2025-11-27)
/// IDA Struct: PACKET_SC_LAUNCH_BULLET_SKILL_POS
/// Size: 54 bytes total
/// Memory Layout (IDA):
...
/// - 0x1A: unsigned __int16 useHP (2 bytes)
/// - 0x1C: unsigned __int16 useMP (2 bytes)
/// - 0x1E: unsigned __int16 useSP (2 bytes)
...
public struct SC_LAUNCH_BULLET_SKILL_POS : IPacketFixed
{
	...
	/// <summary>Skill type ID (offset 0x16)</summary>
	public uint typeID;

	/// <summary>HP cost (offset 0x1A)</summary>
	public ushort useHP;

	/// <summary>MP cost (offset 0x1C)</summary>
	public ushort useMP;

	/// <summary>SP cost (offset 0x1E)</summary>
	public ushort useSP;
