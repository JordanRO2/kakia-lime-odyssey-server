...
/// <summary>
/// Server->Client packet for natural SP (stamina) recovery tick.
/// </summary>
/// <remarks>
/// IDA Verified: Yes (2025-11-27)
/// IDA Struct: PACKET_SC_PC_NATURAL_RECOVERY_SP
/// Size: 14 bytes total
/// Memory Layout (IDA):
...
public struct SC_PC_NATURAL_RECOVERY_SP : IPacketFixed
{
	/// <summary>
