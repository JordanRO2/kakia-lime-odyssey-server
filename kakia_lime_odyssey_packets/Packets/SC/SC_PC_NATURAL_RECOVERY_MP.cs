...
/// <summary>
/// SC_PC_NATURAL_RECOVERY_MP - Server to Client MP natural recovery packet
/// Total size: 14 bytes (including 2-byte PACKET_FIX header)
/// IDA verified: 2025-11-26
/// Structure name in client: PACKET_SC_PC_NATURAL_RECOVERY_MP
/// </summary>
/// <remarks>
/// This packet is sent periodically to update the client with natural MP (Mana Point) regeneration.
/// Triggered by: Server-side periodic natural recovery tick
/// The current field contains the new MP value, difference shows how much was recovered.
/// IDA Details:
/// - Total size: 14 bytes
...
public struct SC_PC_NATURAL_RECOVERY_MP
{
	/// <summary>
